...
const readyDir = `media/exports/READY_TO_SHIP_NOW/stream2-project-moves-offstream-house-v4e-${stamp}`
const exportDir = `media/exports/stream2-project-moves-offstream-house-v4e-${stamp}`
...
const id = `stream-2-project-moves-offstream-house-v4e-${stamp}`
...
const readyPath = `${readyDir}/short-project-moves-offstream-house-v4e.mp4`
...
const manifest = {
  ...
  seo,
  reviewNotes: [
    'Fresh Stream 2 local-only improvement render using restored neutral house frame + subtle travelling shine, centered-screen house v4 layout, and VIBE ZONE + OpenClaw branding.',
...
const clipRecord = {
  ...
  renderPath: out,
  renderUrl: `/${out}`,
  renderPreset: 'stream2-house-v4e-neutral-house-frame-seed',
  renderStatus: 'done',

...
const id = 'stream2-founder-story-privacy-safe-20260514T1100Z'
...
const beats = [
  ...
  { order: 2, role: 'problem', title: 'The real constraint', start: '00:02:12.0', end: '00:03:32.0', chapter: '00:30', excerpt: 'Set up social accounts, VPS, OpenClaw, and make the project progress when I am not here.', rationale: 'Rewind to the practical problem: the build has to move while Masala is offline.' },
  { order: 3, role: 'blocker', title: 'The first clips failed', start: '00:04:58.0', end: '00:05:31.0', chapter: '01:50', excerpt: 'Tests were a total flop: black screen, mid thumbnail, low quality.', rationale: 'Makes the edit honest: the workflow starts rough, not polished.' },
  { order: 4, role: 'build', title: 'Build live, do not leak', start: '00:06:00.0', end: '00:07:42.0', chapter: '02:23', excerpt: 'AI agents, 24/7 work, VPS setup, OpenClaw, and live-stream safety.', rationale: 'Shows the actual build constraint while preserving privacy in this render.' },
  { order: 5, role: 'blocker', title: 'The livestream tax', start: '00:10:16.0', end: '00:12:12.0', chapter: '04:05', excerpt: 'Mic/setup failures interrupt the build until the stream finally works.', rationale: 'Turns the messy setup into story tension without letting it drag.' },
  { order: 6, role: 'result', title: 'Phase one works', start: '00:20:10.8', end: '00:20:48.0', chapter: '06:01', excerpt: 'Phase 1 is done.', rationale: 'Gives viewers a concrete progress marker after the chaos.' },
  { order: 7, role: 'cta', title: 'Follow the off-stream build', start: '00:03:24.0', end: '00:03:32.0', chapter: '06:38', excerpt: 'I still want the project to progress when I am not here.', rationale: 'Ends on the series promise: agents keep building between streams.' },
]
...
const story = {
  ...
  notes: 'Privacy-safe Stream 2 long-form refinement. The source footage is deliberately blurred/dimmed so no terminal/browser/chat text is readable. No external posting/logins/cookies/public exposure.'
}

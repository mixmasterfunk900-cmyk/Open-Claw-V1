...
const readyDir = `media/exports/READY_TO_SHIP_NOW/stream2-project-moves-offstream-house-v4-${stamp}`
const exportDir = `media/exports/stream2-project-moves-offstream-house-v4-${stamp}`

const clip = {
  id: 'clip_stream2_project_moves_offstream_house_v4_20260515T0613Z',
  title: 'Project Moves Off-Stream',
  hook: 'BUILD WHILE OFFSTREAM',
  start: 192.0,
  end: 212.0,
  score: 90,
...
const id = `stream-2-project-moves-offstream-house-v4-${stamp}`
...
const readyPath = `${readyDir}/short-project-moves-offstream-house-v4.mp4`
...
const clipRecord = {
  ...
  renderPath: out,
  renderUrl: `/${out}`,
  renderPreset: 'stream2-house-v4-centered-screen-house-brand-seed-offstream-progress',
  renderStatus: 'done',

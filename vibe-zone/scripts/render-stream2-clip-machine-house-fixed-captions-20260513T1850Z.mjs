...
const startSec = 158
const duration = 22
const id = 'stream-2-build-the-clip-machine-live-house-fixed-captions-20260513T1850Z'
...
const vf = [
  ...
  '[screensrc]scale=1030:-2:force_original_aspect_ratio=decrease,setsar=1[screenfit]',

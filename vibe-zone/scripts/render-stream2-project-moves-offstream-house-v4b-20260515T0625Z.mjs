...
const readyDir = `media/exports/READY_TO_SHIP_NOW/stream2-project-moves-offstream-house-v4b-${stamp}`
const exportDir = `media/exports/stream2-project-moves-offstream-house-v4b-${stamp}`

const clip = {
  id: 'clip_stream2_project_moves_offstream_house_v4b_20260515T0625Z',
...
const id = `stream-2-project-moves-offstream-house-v4b-${stamp}`
...
const readyPath = `${readyDir}/short-project-moves-offstream-house-v4b.mp4`
...
const vf = [
  ...
  `[srcmain]crop=iw*0.72:ih-92:0:92,scale=${videoW}:${videoH}:force_original_aspect_ratio=increase,crop=${videoW}:${videoH},setsar=1[screenfit]`,
...
const manifest = {
  ...
  reviewNotes: [
    ...
    'White one-word captions stay in the safe zone above the brand lane; source screen is left-zoomed to remove dead desktop space.',
...
const clipRecord = {
  ...
  renderPath: out,
  renderUrl: `/${out}`,
  renderPreset: 'stream2-house-v4b-left-zoom-safe-header-seed-offstream-progress',
  renderStatus: 'done',

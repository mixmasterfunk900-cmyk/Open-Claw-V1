...
type MediaFile = { name: string; kind: 'source' | 'transcript' | 'render'; path: string; url: string; size: number; updatedAt: string; validation?: MediaValidation }

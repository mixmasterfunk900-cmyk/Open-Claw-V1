...
function Dashboard({ state }: { state: AppState; setPage: (page: PageId) => void }) {
  ...
  const latestSource = latestStream ? state.mediaFiles.find((file) => file.kind === 'source' && file.name.startsWith(`${latestStream.id}.`)) : undefined

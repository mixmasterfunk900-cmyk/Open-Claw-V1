...
const readyDir = `media/exports/READY_TO_SHIP_NOW/stream2-clips-first-vps-next-house-v4-${stamp}`
const exportDir = `media/exports/stream2-clips-first-vps-next-house-v4-${stamp}`

const clip = {
  id: 'clip_stream2_clips_first_vps_next_house_v4_20260515T0442Z',
...
const id = `stream-2-clips-first-vps-next-house-v4-${stamp}`
...
const readyPath = `${readyDir}/short-clips-first-vps-next-house-v4.mp4`
...
const manifest = {
  ...
  seo,
  reviewNotes: [
    'Fresh Stream 2 local-only render using the centered-screen house v4 layout with VIBE ZONE + OpenClaw branding.',
...
const clipRecord = {
  ...
  hashtags: clip.hashtags,
  reason: 'Fresh Stream 2 overnight production clip: concise roadmap from social setup to clips to VPS, rendered with the current house-style layout.',
  createdAt: now,
  renderPath: out,
  renderUrl: `/${out}`,
  renderPreset: 'stream2-house-v4-centered-screen-house-brand-seed',
  renderStatus: 'done',

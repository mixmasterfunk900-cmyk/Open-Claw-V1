...
const readyDir = `media/exports/READY_TO_SHIP_NOW/stream2-fulltime-247-build-house-v4c-${stamp}`
const exportDir = `media/exports/stream2-fulltime-247-build-house-v4c-${stamp}`

const clip = {
  id: 'clip_stream2_fulltime_247_build_house_v4c_20260515T0918Z',
...
const id = `stream-2-fulltime-247-build-house-v4c-${stamp}`
...
const readyPath = `${readyDir}/short-fulltime-247-build-house-v4c.mp4`
...
const manifest = {
  ...
  seo,
  reviewNotes: [
    'Fresh Stream 2 local-only rerender using Confirmed Template #1 retention border + travelling shine, centered-screen house v4c layout, and VIBE ZONE + OpenClaw branding.',
    ...
    'Stream-safe founder thesis clip: OpenClaw on VPS, phone/off-stream control, night streaming + day-job constraint; no secrets/logins/cookies/API posting.',
  ],
}
...
const clipRecord = {
  ...
  hashtags: clip.hashtags,
  reason: 'Fresh Stream 2 v4c rerender of a strong founder-thesis clip: stream at night, build while working, rendered with current centered-screen/white-caption/branding lessons, trimmed to skip the garbled opening caption.',
  createdAt: now,
  renderPath: out,
  renderUrl: `/${out}`,
  renderPreset: 'stream2-house-v4c-founder-thesis-retention-border-shine-seed',
  renderStatus: 'done',

...
const clip = {
  id: 'clip_stream2_fix_mic_huge_day_house_v4_20260515T0010Z',
...
const manifest = {
  ...
  reviewNotes: [
    ...
    'Clip is stream-safe: no secrets, no login/cookies/API posting, and no external service use.',
  ],
}

...
const id = 'stream2-founder-story-tight-privacy-safe-20260514T1500Z'
...
const beats = [
  { order: 1, role: 'hook', title: 'A ridiculous thesis', start: '01:21:32.0', end: '01:22:02.0', chapter: '00:00', excerpt: 'The first day we are going to make a billion dollar company from scratch with no experience.', rationale: 'Open on the biggest promise so the audience knows the ambition immediately.' },
  { order: 2, role: 'problem', title: 'The real constraint', start: '00:02:12.0', end: '00:03:24.0', chapter: '00:30', excerpt: 'Set up social accounts, VPS, OpenClaw, and make the project progress when I am not here.', rationale: 'Rewind to the practical problem, but stop before repeating the final CTA line.' },
  { order: 3, role: 'blocker', title: 'The first clips failed', start: '00:04:58.0', end: '00:05:31.0', chapter: '01:42', excerpt: 'Tests were a total flop: black screen, mid thumbnail, low quality.', rationale: 'Makes the edit honest: the workflow starts rough, not polished.' },
  { order: 4, role: 'build', title: 'Build live, do not leak', start: '00:06:00.0', end: '00:07:06.0', chapter: '02:15', excerpt: 'AI agents, 24/7 work, VPS setup, OpenClaw, and live-stream safety.', rationale: 'Keeps the concrete live-build constraint while trimming repeated setup chatter.' },
  { order: 5, role: 'blocker', title: 'The livestream tax', start: '00:10:16.0', end: '00:10:56.0', chapter: '03:21', excerpt: 'Mic/setup failures interrupt the build until the stream finally works.', rationale: 'A short taste of friction is enough; the previous 6:46 candidate spent too long here.' },
  { order: 6, role: 'result', title: 'Phase one works', start: '00:20:10.8', end: '00:20:48.0', chapter: '04:01', excerpt: 'Phase 1 is done.', rationale: 'Gives viewers a concrete progress marker after the chaos.' },
  { order: 7, role: 'cta', title: 'Follow the off-stream build', start: '00:03:24.0', end: '00:03:32.0', chapter: '04:38', excerpt: 'I still want the project to progress when I am not here.', rationale: 'Ends on the series promise: agents keep building between streams.' },
]
...
const story = {
  ...
  notes: 'Tighter privacy-safe Stream 2 long-form refinement. The source footage is deliberately blurred/dimmed so no terminal/browser/chat text is readable. No external posting/logins/cookies/public exposure.'
}
...
console.log(JSON.stringify({ id, out, ready: `${readyDir}/long-stream2-founder-story-tight-privacy-safe-20260514T1500Z.mp4`, duration, captions: assPath, captionQa: qa, screenshot: `${reviewDir}/${id}-screenshot.jpg`, contactSheet: `${reviewDir}/${id}-contact-sheet.jpg`, ffprobe: JSON.parse(probe.stdout) }, null, 2))

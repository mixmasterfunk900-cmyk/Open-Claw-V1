...
const stamp = '20260514T1125Z'
const id = `thumbnail-looks-mid-house-v3-${stamp}`
...
const headerText = 'WHY IT LOOKS MID'
...
await copyFile(path.join(root, out), path.join(root, readyDir, 'short-thumbnail-looks-mid-house-v3.mp4'))
await copyFile(path.join(root, `${reviewDir}/${id}-contact-sheet.jpg`), path.join(root, readyDir, 'short-thumbnail-looks-mid-house-v3-contact-sheet.jpg'))
await copyFile(path.join(root, `${exportDir}/thumbnail.jpg`), path.join(root, readyDir, 'short-thumbnail-looks-mid-house-v3-thumbnail.jpg'))

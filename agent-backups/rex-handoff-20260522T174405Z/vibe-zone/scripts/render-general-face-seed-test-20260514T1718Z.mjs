...
const seedSource = '/root/.openclaw/media/tool-image-generation/thumbnail-looks-mid-general-masala-seed-frame---ace64755-4bda-46ae-b545-7f4efde6e4f9.jpg'
const id = 'thumbnail-looks-mid-general-face-seed-test-20260514T1718Z'
...
await writeFile(path.join(root, exportDir, 'notes.md'), `# Gotham seed frames test\n\nAdds a visible 4-frame general related Masala-face (${seedDuration.toFixed(3)}s) Gotham-style thumbnail seed frame at the start of the short. Test only; Confirmed Template #1 unchanged.\n`)

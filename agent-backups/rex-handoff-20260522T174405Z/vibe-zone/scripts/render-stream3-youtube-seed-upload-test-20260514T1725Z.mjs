...
const seedSource = '/root/.openclaw/media/tool-image-generation/stream3-one-stream-face-seed-frame---d8ac53c2-6722-4e45-b866-45b7e166804b.jpg'
const id = 'stream3-one-stream-youtube-seed-upload-test-20260514T1725Z'
...
await writeFile(path.join(root, exportDir, 'notes.md'), `# Stream 3 YouTube seed-frame upload test\n\nInput: ${input}\n\nAdds a 0.5s face-led Gotham-style seed frame at the start for YouTube thumbnail-selection testing, then plays the Stream 3 short with the confirmed solid template look. Test only; Confirmed Template #1 is unchanged until approved.\n`)

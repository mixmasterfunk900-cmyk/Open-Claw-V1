...
const seedSource = '/root/.openclaw/media/tool-image-generation/thumbnail-looks-mid-seed-frame---3f35c100-b165-4792-bd70-12212f48920c.jpg'
const id = 'thumbnail-looks-mid-gotham-seed-frames-test-20260514T1658Z'
...
await writeFile(path.join(root, exportDir, 'notes.md'), `# Gotham seed frames test\n\nAdds a visible 4-frame (${seedDuration.toFixed(3)}s) Gotham-style thumbnail seed frame at the start of the short. Test only; Confirmed Template #1 unchanged.\n`)
...
console.log(JSON.stringify({ id, seed, seedDuration, out, ready, review, exportDir, ffprobe: JSON.parse(probe.stdout) }, null, 2))

...
const id = 'day3-product-content-machine-privacy-safe-20260514T1905Z'
...
const story = {
  ...
  notes: 'Privacy-safe Day 3 upload-candidate refresh. Full livestream image is blurred/dimmed before captions/logo. No external posting/logins/cookies/public exposure.'
}
...
await copyFile(path.join(root, out), path.join(root, readyDir, 'long-day3-product-content-machine-privacy-safe-20260514T1905Z.mp4'))
await copyFile(path.join(root, `${reviewDir}/${id}-contact-sheet.jpg`), path.join(root, readyDir, 'long-day3-product-content-machine-privacy-safe-contact-sheet-20260514T1905Z.jpg'))
await copyFile(path.join(root, assPath.replace(/\.ass$/, '.qa.json')), path.join(root, readyDir, 'long-day3-product-content-machine-privacy-safe-caption-qa-20260514T1905Z.json'))

console.log(JSON.stringify({ id, out, ready: `${readyDir}/long-day3-product-content-machine-privacy-safe-20260514T1905Z.mp4`, duration, captions: assPath, captionQa: qa, contactSheet: `${reviewDir}/${id}-contact-sheet.jpg`, ffprobe: JSON.parse(probe.stdout) }, null, 2))

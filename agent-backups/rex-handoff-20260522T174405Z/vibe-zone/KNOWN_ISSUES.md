...
- Facecam tracking is implemented and surfaced for new `facecam-smart` renders; older facecam-smart renders without tracking metadata should be re-rendered before presenting them as ready.

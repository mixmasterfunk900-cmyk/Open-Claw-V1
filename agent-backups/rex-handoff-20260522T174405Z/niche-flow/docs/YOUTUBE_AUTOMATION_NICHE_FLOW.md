> Canonical master template: `../templates/MASTER_YOUTUBE_AUTOMATION_FLOW.md`
>
> Niche-specific implementations live under `../niches/`. Do not mix SOP documents across niches.
...
Review candidate naming:

```text
*-audio-truth-captioned*.mp4
```
...
- Send a 1-minute review cut.
- Burn visible captions into the Telegram review cut only.
- Keep the master clean with soft subtitle track.
- State whether the cut is a review cut or production master.
